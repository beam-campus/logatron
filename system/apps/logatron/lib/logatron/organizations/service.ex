defmodule Farms.Service do
  ...
  alias Organization.Facts, as: OrganizationFacts
  alias Organization.Init, as: OrganizationInit
  alias Field.Init, as: FieldInit

  @initializing_farm_v1 OrganizationFacts.initializing_farm_v1()
  @farm_detached_v1 OrganizationFacts.farm_detached_v1()
  @farms_cache_updated_v1 OrganizationFacts.farms_cache_updated_v1()
  ...
  def build_fields(%OrganizationInit{} = mng_farm_init),
    do:
  ...
  ############# handle_info ##############
  @impl GenServer
  def handle_info({@initializing_farm_v1, %OrganizationInit{} = mng_farm_init}, state) do
  ...
  @impl GenServer
  def handle_info({@farm_detached_v1, %OrganizationInit{} = mng_farm_init}, state) do
    key = mng_farm_init.id
