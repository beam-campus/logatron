defmodule Organization.Server do
  use GenServer
  ...
  # def initiate_nature(%OrganizationInit{} = mng_farm_init) do
  ...
  defp do_start_born2died(%Life{} = life, %OrganizationInit{} = mng_farm_init) do
    DynamicSupervisor.start_child(
  ...
  ################# PLUMBING ##################
  def start_link(%OrganizationInit{} = mng_farm_init),
    do:
  ...
  def child_spec(%OrganizationInit{} = mng_farm_init) do
    %{
