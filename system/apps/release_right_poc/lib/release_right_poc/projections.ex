defmodule ReleaseRightPoc.Projections do
  @moduledoc """
  ...
  def start_link(_args) do
    children = [
      ReleaseRightPoc.InitializeRRPoc.ToLog,
    ...
    Supervisor.start_link(children, strategy: :one_for_one, name: ReleaseRightPoc.Projections)
